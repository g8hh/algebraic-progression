function runAutomationCoreScript() {
    ...
    if(player.integration.challenge != 4 && player.integration.chalCompletions[4] < 13 && auto.autoCCSweep && player.i.gte(new Decimal(auto.startCCSweepReq))) {
        if(player.compChalCompletions[1] < 5 && player.unlocked == 0) {
          interactWithCC(1)
        }
