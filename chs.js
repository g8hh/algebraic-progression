...
var cnItems = {
    ...
    "and 1e660 Root Essence to go Complex.": "和 1e660 根本精华去复杂。",
    "AP Classic": "AP经典",
    "Auto-Complex: Go Complex when reaching": "自动复杂：到达时变得复杂",
    "Base QP Generation Formula: (bc": "基本 QP 生成公式：(bc",
    "Basic Complex Upgrades": "基本复杂升级",
    ...
    "Once all 12 Complex Upgrades are bought once, a second level of each upgrade is unlocked.": "一旦购买了所有 12 个复杂升级，每个升级的第二个级别将被解锁。",
    "Original Rewrite": "原始重写",
    ...
    "Unlock Functions.": "解锁函数。",
    "Upgrade points are spent on the 12 Complex Upgrades that can be respecced.": "升级点用于可重洗的 12 个复杂升级。",
...
var cnRegReplace = new Map([
    ...
    [/^You have produced (.+) points in total.$/, '您总共产生了 $1 点数。'],
    [/^Number = (.+)$/, '数字 = $1'],
